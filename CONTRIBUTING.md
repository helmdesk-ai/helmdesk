...
Thanks for helping improve HelmDesk.

## Before you start

- Open an issue or discussion first for larger changes so the direction is clear.
...
This effectively serves as an inbound contributor license agreement (CLA). If you cannot agree to these terms, please do not submit contributions.
