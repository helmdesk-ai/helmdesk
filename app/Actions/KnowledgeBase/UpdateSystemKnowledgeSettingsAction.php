...
use App\Jobs\KnowledgeDocument\RebuildSystemKnowledgeIndexJob;
...
class UpdateSystemKnowledgeSettingsAction
{
     ...
     * 保存检索配置并视需要派发索引重建任务。
     */
    public function handle(SystemContext $systemContext, FormUpdateSystemKnowledgeSettingsData $data): void
    {
        ...
        if ($strategies !== [] || $rebuildQaVectorIndex) {
            RebuildSystemKnowledgeIndexJob::dispatch(
