    ...
    public function brands(): array
    {
        return [
            'openai' => [
                ...
                'default_models' => [
                    $this->model('gpt-5.5', 'GPT-5.5', 'llm'),
                    $this->model('gpt-5.4-mini', 'GPT-5.4 Mini', 'llm'),
                    $this->model('gpt-5.4-nano', 'GPT-5.4 Nano', 'llm'),
                    $this->model('text-embedding-3-large', 'Text Embedding 3 Large', 'embedding'),
                    $this->model('text-embedding-3-small', 'Text Embedding 3 Small', 'embedding'),
                ],
            ],
            'anthropic' => [
                'label' => 'Anthropic',
                ...
                'default_models' => [
                    $this->model('claude-opus-4-7', 'Claude Opus 4.7', 'llm'),
                    $this->model('claude-sonnet-4-6', 'Claude Sonnet 4.6', 'llm'),
                    $this->model('claude-haiku-4-5', 'Claude Haiku 4.5', 'llm'),
                ],
            ],
            'gemini' => [
                'label' => 'Google Gemini',
                ...
                'default_models' => [
                    $this->model('gemini-3.5-flash', 'Gemini 3.5 Flash', 'llm'),
                ],
            ],
            'deepseek' => [
                'label' => 'DeepSeek',
                ...
                'default_models' => [
                    $this->model('deepseek-v4-pro', 'DeepSeek V4 Pro', 'llm'),
                    $this->model('deepseek-v4-flash', 'DeepSeek V4 Flash', 'llm'),
                ],
            ],
            'openrouter' => [
                'label' => 'OpenRouter',
                ...
                'default_models' => [
                    $this->model('openai/gpt-5.5', 'GPT-5.5', 'llm'),
                    $this->model('anthropic/claude-opus-4-7', 'Claude Opus 4.7', 'llm'),
                    $this->model('deepseek/deepseek-v4-flash', 'DeepSeek V4 Flash', 'llm'),
                    $this->model('openai/text-embedding-3-small', 'Text Embedding 3 Small', 'embedding'),
                ],
            ],
            'qwen' => [
                'label' => 'Qwen',
                ...
                'default_models' => [
                    $this->model('qwen3.6-max-preview', 'Qwen3.6 Max Preview', 'llm'),
                    $this->model('qwen3.6-plus', 'Qwen3.6 Plus', 'llm'),
                    $this->model('qwen3.6-flash', 'Qwen3.6 Flash', 'llm'),
                    $this->model('qwen3-max', 'Qwen3 Max', 'llm'),
                    $this->model('qwen3-coder-plus', 'Qwen3 Coder Plus', 'llm'),
                    $this->model('text-embedding-v4', 'Text Embedding V4', 'embedding'),
                ],
            ],
            'ark' => [
