...
return [
    ...
    'decimal' => '必须有 :decimal 位小数。',
    'declined' => '必须是拒绝的。',
    'declined_if' => '当 :other 为 :value 时字段必须是拒绝的。',
    ...
    'doesnt_end_with' => '不能以以下之一结尾: :values。',
    'doesnt_start_with' => '不能以下列之一开头: :values。',
    'email' => '不是一个合法的邮箱。',
    'ends_with' => '必须以 :values 为结尾。',
    'enum' => '值不正确。',
    'exists' => '不存在。',
    'extensions' => '字段必须具有以下扩展名之一：:values。',
    'file' => '必须是文件。',
    'filled' => '不能为空。',
    'gt' => [
    ...
    'min_digits' => '必须至少有 :min 位数。',
    'missing' => '必须缺少字段。',
    'missing_if' => '当 :other 为 :value 时，必须缺少字段。',
    'missing_unless' => '必须缺少字段，除非 :other 是 :value。',
    'missing_with' => '存在 :values 时，必须缺少字段。',
    'missing_with_all' => '存在 :values 时，必须缺少字段。',
    ...
    'password' => [
        'letters' => '必须至少包含一个字母。',
        'mixed' => '必须至少包含一个大写字母和一个小写字母。',
        'numbers' => '必须至少包含一个数字。',
        'symbols' => '必须至少包含一个符号。',
        'uncompromised' => '出现在已经泄漏的密码中。请选择不同的密码。',
    ],
    'present' => '必须存在。',
    'present_if' => '当 :other 等于 :value 时，必须存在字段。',
    'present_unless' => '除非 :other 等于 :value，否则字段必须存在。',
    'present_with' => '当 :values 存在时，字段必须存在。',
    'present_with_all' => '当存在 :values 时，必须存在字段。',
    'prohibited' => '字段被禁止。',
    'prohibited_if' => '当 :other 为 :value 时，禁止字段。',
    'prohibited_if_accepted' => '字段在 :other 被接受时禁止。',
    'prohibited_if_declined' => '字段在 :other 被拒绝时禁止。',
    'prohibited_unless' => '字段被禁止，除非 :other 位于 :values 中。',
    'prohibits' => '字段禁止出现 :other。',
    'regex' => '格式不正确。',
    'required' => '不能为空。',
    'required_array_keys' => '至少包含指定的键：:values.',
    'required_if' => '当 :other 为 :value 时不能为空。',
    'required_if_accepted' => '当 :other 存在时，不能为空。',
    'required_if_declined' => '当 :other 不存在时，不能为空。',
    ...
    'attributes' => [
        'address' => '地址',
        'affiliate_url' => '附属网址',
        'reception_plan_version_id' => '接待方案版本',
        'age' => '年龄',
        'amount' => '数额',
        'announcement' => '公告',
        'area' => '区域',
