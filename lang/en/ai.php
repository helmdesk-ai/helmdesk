...
return [
    ...
    'model_purposes' => [
        'reception_chat' => 'Reception Agent',
        'background_task' => 'Task Agent',
        'assistant' => 'AI Q&A',
        'embedding' => 'Vector Search',
        'rerank' => 'ReRank',
        'summary' => 'Conversation Summary',
    ],
    'purpose_type_mismatch' => 'The selected purposes do not match the model capability type.',
    'model_purpose_exists' => 'This model is already added for this purpose under the provider.',
    'models_invalid_reorder' => 'The order does not match the current model list. Please refresh and retry.',
