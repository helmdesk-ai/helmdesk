...
return [
    ...
    'messages' => [
        ...
        'invalid_embedding_model' => 'Please choose an available Embedding model in the current workspace.',
        'invalid_embedding_dimension' => 'Please enter the embedding model dimension (an integer between 1 and 65535).',
        'invalid_rerank_model' => 'Please choose an available ReRank model in the current workspace.',
