...
const submitCreate = () => {
  createForm.post(admin.manage.attributes.store.url(), {
    preserveScroll: true,
    onSuccess: () => {
...
const submitEdit = () => {
  ...
  editForm.put(
    admin.manage.attributes.update.url({
...
const submitArchive = () => {
  ...
  archiveForm.put(
    admin.manage.attributes.archive.url({
...
const moveDefinition = (definitionId: string, direction: 'up' | 'down') => {
  ...
  reorderForm.put(admin.manage.attributes.reorder.url(), {
    preserveScroll: true,
  });
};
</script>
          ...
          <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <Button variant="outline" as-child>
                <Link :href="admin.manage.attributes.trash.url()">
                  {{ t('回收站') }}
                </Link>
              </Button>
            </div>
