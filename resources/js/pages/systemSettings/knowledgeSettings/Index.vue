...
import type {
  ...
  ShowSystemKnowledgeSettingsPagePropsData,
} from '@/types/generated';
import { Form, Head } from '@inertiajs/vue3';
import { computed, ref, watch } from 'vue';

const props = defineProps<ShowSystemKnowledgeSettingsPagePropsData>();
        ...
        >
          ...
          >
            <Select v-model="selectedChunkingStrategy">
              ...
              <SelectContent>
                <SelectItem
                  v-for="option in props.chunking_strategy_options"
                  :key="option.value"
