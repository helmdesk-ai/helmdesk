...
export default {
  // 设置二级侧边栏
  工作区: '工作区',
  '管理工作区与 AI 相关配置': '管理工作区与 AI 相关配置',
  '管理工作区设置、数据能力与 AI 配置': '管理工作区设置、数据能力与 AI 配置',
  常规设置: '常规设置',
  ...
  知识库: '知识库',
  知识库列表: '知识库列表',
  '管理工作区知识库、文档和检索能力': '管理工作区知识库、文档和检索能力',
  ...
  暂无已删除的知识库: '暂无已删除的知识库',
  '确认删除知识库？': '确认删除知识库？',
  '删除后该知识库将从当前工作区移除。': '删除后该知识库将从当前工作区移除。',
  '删除后该知识库会被移到回收站，可随时恢复。':
    '删除后该知识库会被移到回收站，可随时恢复。',
  '确认恢复知识库？': '确认恢复知识库？',
  '恢复后将重新出现在知识库列表中。': '恢复后将重新出现在知识库列表中。',
  '为当前工作区添加一个知识库。': '为当前工作区添加一个知识库。',
  ...
  '单次最多上传 {count} 个文件，多余的已忽略。':
    '单次最多上传 {count} 个文件，多余的已忽略。',
  管理工作区下的知识库和文档分组: '管理工作区下的知识库和文档分组',
  管理系统知识库和文档分组: '管理系统知识库和文档分组',

  网站渠道: '网站渠道',
  '管理当前工作区的网站 AI 入口。': '管理当前工作区的网站 AI 入口。',
  网站: '网站',
  管理工作区下的访客接入渠道: '管理工作区下的访客接入渠道',
