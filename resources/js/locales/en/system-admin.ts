...
export default {
  // 设置二级侧边栏
  系统: 'System',
  '管理系统与 AI 相关配置': 'Manage system and AI configuration',
  '管理系统设置、数据能力与 AI 配置':
    'Manage system settings, data capabilities, and AI configuration',
  常规设置: 'General',
  ...
  '将从当前系统移除该成员的访问权限（不会删除用户）。':
    'Revoke this member’s access to the current system (the user account will not be deleted).',
  ...
  '管理当前系统下的大模型供应商凭据与可用模型。':
    'Manage LLM provider credentials and available models for this admin.',
  '管理系统级大模型供应商凭据与可用模型。':
    'Manage system-wide LLM provider credentials and available models.',
  默认模型: 'Default model',
  大语言模型: 'LLM Model',
  默认大语言模型: 'Default LLM Model',
  '为当前系统配置默认模型。': 'Configure default models for this admin.',
  '为当前系统配置默认模型、AI 最大并发配置和过载提示文案。':
    'Configure the default model, AI max concurrency, and overload message for this admin.',
  ...
  '控制当前系统同一时间最多处理多少 AI 请求。':
    'Control how many AI requests this system can process at the same time.',
  '用于当前系统 AI 运行时过载保护时向用户展示的提示文案。':
    'Message shown to users when this system hits AI runtime overload protection.',
  '例如：当前 AI 请求较多，请稍后再试。':
  ...
  '当前系统没有可用的启用模型，请先在大模型供应商中启用至少一个大语言模型':
    'No active models in this admin. Enable at least one LLM model in LLM Providers first.',
  ...
  '这是系统内部的本地保护阈值，不能超过 AI 最大并发配置。':
    'This is a local safety limit inside the system and cannot exceed the AI max concurrency setting.',
  '超过上限后，系统会结束本轮任务。':
  ...
  模型名称: 'Model name',
  '模型 ID': 'Model ID',
  继承系统默认模型: 'Use the system default model',
  当前系统默认模型: 'Current system default model',
  当前模型: 'Current model',
  关键配置: 'Key settings',
  最近更新: 'Updated',
  继承系统默认: 'Uses system default',
  独立模型: 'Custom model',
  '系统默认模型当前不可用，请先在默认模型设置中修正或改为单独指定模型。':
    'The system default model is unavailable. Fix it in default model settings or choose a model explicitly.',
  '模型当前不可用，后续运行前需要修正。':
  ...
  单独指定模型: 'Choose a model for this system',
  指定模型: 'Select model',
  ...
  '管理系统的接待方案配置与已发布版本。':
    'Manage reception plan configuration and published versions for this admin.',
  创建方案: 'Create plan',
  方案名称: 'Plan name',
  ...
  '管理系统知识库、文档和检索能力':
    'Manage knowledge bases, documents, and retrieval for this system',
  '管理当前系统可供 AI 接待检索的知识库。':
    'Manage knowledge bases that AI reception can search in this admin.',
  ...
  '删除后该知识库将从当前系统移除。':
    'After deletion, this knowledge base will be removed from the current admin.',
  ...
  '当前系统内所有知识库共用这套检索配置。':
    'All knowledge bases in this system share these retrieval settings.',
  '系统内所有知识库共用这套检索配置。':
  ...
  '保存后会清理当前系统已有知识库索引，并按新的配置重新构建。':
    'Saving will clear existing knowledge base indexes in this system and rebuild them with the new settings.',
  ...
  管理系统下的知识库和文档分组:
    'Manage knowledge bases and document groups in this system',
  管理系统知识库和文档分组: 'Manage system knowledge bases and document groups',

  网站渠道: 'Web channels',
  '管理当前系统的网站 AI 入口。':
    'Manage the web AI entry points for the current admin.',
  网站: 'Website',
  管理系统下的访客接入渠道: 'Manage visitor channels for this system',
